...
#new products here
class Newsprint(Paper):# a PRODUCT - keep it!
    def __str__(self):
        return "newsprint page"
class ThinCard(Paper):# a PRODUCT - keep it!
    def __str__(self):
        return "thin cardboard cover"
    
# Creators
class Book(object): # an inflexible concrete CREATOR class
    def makePage(self):
        pass
    def makeCover(self):
        pass
    ...
    def __init__(self, title): # MONOLITHIC method which does NOT 'abstract the instantiation process'
        ...
        self.parts = []
        self.parts.append( self.makeCover() )
        self.parts.append( self.makePage() )
        self.parts.append( self.makePage() )
        self.parts.append( self.makePage() )
        self.parts.append( self.makePage() )
        self.parts.append( self.makeCover() )
...
class ArtBook(Book): # an inflexible concrete CREATOR class
    def makePage(self):
        return Page()
    def makeCover(self):
        return Cover()   
...
class TechBook(Book): # an inflexible concrete CREATOR class
    def makePage(self):
        return Newsprint()
    def makeCover(self):
        return ThinCard()   
