...
class GoodBaby(object): # a CREATOR class(in the sense that creating a baby creates a mind)
    def __init__(self): # MONOLITHIC method which does NOT 'abstract the instantiation process'
        # here is some creation 
        self.personality = []
        self.personality.append( GoodAttitude() )
        self.personality.append( GoodTemperament() )
