...
if __name__ == "__main__":
    ...
    print(doc.tokens)
    # ['"FONT"="timesRoman"', '"H"="Once upon a time..."', '"P"="There was a student doing a programming test."', '"P"="It was hard"']

"""
additional functionality required is
same input but HTML format output
